  ...
  return (
    <div className="qa-simple">
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 text-xs font-semibold text-mint">Lab {lab.number} | {lab.track} | {lab.status}</p>
        <h1 className="mt-3 text-4xl font-black leading-tight text-off-white">{lab.title}</h1>
