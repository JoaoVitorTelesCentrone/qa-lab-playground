...
export const plantedBugs: PlantedBug[] = [
  ...
  },
  {
    ...
    symptom: "O mesmo horário pode ser reservado por dois clientes diferentes sem erro. A grade do dia também deixa de marcar o horário como ocupado.",
    mechanism: "A verificação de conflito exige que o cliente seja o mesmo, então só barra a duplicidade quando é a mesma pessoa.",
    severity: "critica",
